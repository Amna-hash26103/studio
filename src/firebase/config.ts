...
export const firebaseConfig = {
  apiKey: process.env.NEXT_PUBLIC_FIREBASE_API_KEY || "AIzaSyDRdot2xSkDv75AjucHdkhLrGi_JprEKxc",
  ...
  appId: process.env.NEXT_PUBLIC_FIREBASE_APP_ID || "1:282325221759:web:8097fe973c34061ce85a4a",
  measurementId: process.env.NEXT_PUBLIC_FIREBASE_MEASUREMENT_ID || "G-8KZEJ9XXGV"
};
